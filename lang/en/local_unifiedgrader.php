...
$string['bbb_annotation_media_only'] = 'Audio or video comment — listen to it in the online feedback view.';
...
$string['bbb_filter_nogroups'] = 'Showing every session: this activity runs in separate groups, but this student is not in any group with access to it, so the sessions they could have joined cannot be identified.';
...
$string['feedback_summary_page_of'] = 'Page {$a->page} of {$a->total}';
$string['feedback_summary_recording_comments'] = 'Recording comments';
$string['feedback_summary_sessions_total'] = 'Across {$a} session(s) attended';
